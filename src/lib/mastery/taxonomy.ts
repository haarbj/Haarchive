...
export const TOPIC_SEEDS: TopicSeed[] = [
  { slug: "how-to-start-running", title: "How to Start Running", categorySlug: "practice", sectionSlug: "how-to-start-running" },
  { slug: "training-philosophy", title: "Training Philosophy", categorySlug: "philosophy", sectionSlug: "training-philosophy" },
  { slug: "the-philosophy-of-running", title: "The Philosophy of Running", categorySlug: "philosophy", sectionSlug: "the-philosophy-of-running" },
  { slug: "exercise-physiology", title: "Exercise Physiology", categorySlug: "physiology", sectionSlug: "exercise-physiology" },
  { slug: "the-aerobic-base", title: "The Aerobic Base", categorySlug: "physiology", sectionSlug: "the-aerobic-base" },
  { slug: "research-library", title: "Research Library", categorySlug: "physiology", sectionSlug: "research-library" },
  { slug: "data-and-analytics", title: "Data & Analytics", categorySlug: "physiology", sectionSlug: "data-and-analytics" },
  { slug: "what-a-race-result-can-tell-you", title: "What One Race Result Can (and Can't) Tell You", categorySlug: "physiology", sectionSlug: "what-a-race-result-can-tell-you" },
  // philosophy, not physiology -- mirrors the same deliberate exception in
  // sections.ts (this topic is about weighing conflicting evidence, a
  // Philosophy question, unlike its old the-science siblings above).
  { slug: "mostly-easy-genuinely-hard", title: "The Case for Mostly Easy, Genuinely Hard Training", categorySlug: "philosophy", sectionSlug: "mostly-easy-genuinely-hard" },
  { slug: "coaching-library", title: "Coaching Library", categorySlug: "practice", sectionSlug: "coaching-library" },
  { slug: "athlete-library", title: "Athlete Library", categorySlug: "practice", sectionSlug: "athlete-library" },
  { slug: "marathon-training", title: "Marathon Training", categorySlug: "practice", sectionSlug: "marathon-training" },
  { slug: "workout-library", title: "Workout Library", categorySlug: "practice", sectionSlug: "workout-library" },
  { slug: "trail-and-ultra-training", title: "Trail & Ultra Running", categorySlug: "practice", sectionSlug: "trail-and-ultra-training" },
  { slug: "strength-training", title: "Strength Training for Runners", categorySlug: "practice", sectionSlug: "strength-training" },
  { slug: "5k-training", title: "5K Training", categorySlug: "practice", sectionSlug: "5k-training" },
  { slug: "training-plans", title: "Training Plans", categorySlug: "practice", sectionSlug: "training-plans" },
  { slug: "nutrition-and-fueling", title: "Nutrition & Fueling", categorySlug: "physiology", sectionSlug: "nutrition-and-fueling" },
  { slug: "recovery", title: "Recovery", categorySlug: "physiology", sectionSlug: "recovery" },
  { slug: "training-across-the-menstrual-cycle", title: "Training Across the Menstrual Cycle", categorySlug: "physiology", sectionSlug: "training-across-the-menstrual-cycle" },
  { slug: "pregnancy-and-postpartum-running", title: "Pregnancy and Postpartum Running", categorySlug: "physiology", sectionSlug: "pregnancy-and-postpartum-running" },
  { slug: "training-through-the-decades", title: "Training Through the Decades", categorySlug: "physiology", sectionSlug: "training-through-the-decades" },
  { slug: "sports-psychology", title: "Sports Psychology", categorySlug: "psychology", sectionSlug: "sports-psychology" },
  { slug: "goal-setting", title: "Goal Setting & Identity", categorySlug: "psychology", sectionSlug: "goal-setting" },
  { slug: "self-talk", title: "Self-Talk & Mental Technique", categorySlug: "psychology", sectionSlug: "self-talk" },
  { slug: "daily-practice", title: "Consistency & Daily Practice", categorySlug: "psychology", sectionSlug: "daily-practice" },
  { slug: "performing-under-pressure", title: "Performing Under Pressure", categorySlug: "psychology", sectionSlug: "performing-under-pressure" },
  { slug: "for-coaches", title: "For Coaches", categorySlug: "psychology", sectionSlug: "for-coaches" },
  { slug: "articles", title: "Articles", categorySlug: "archive", sectionSlug: "articles" },
  { slug: "resources", title: "Resources", categorySlug: "archive", sectionSlug: "resources" },
  { slug: "choosing-a-pace-calculator", title: "Choosing a Pace Calculator", categorySlug: "tools", sectionSlug: "choosing-a-pace-calculator" },
