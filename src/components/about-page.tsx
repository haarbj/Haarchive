...
const timeline: {
...
}[] = [
  {
    ...
    photoAlt:
      "Brody Haar wearing a state championship medal at an AIA meet in Brophy colors",
    photoLabel:
      "High school era -- racing or training in Brophy colors, Flagstaff altitude camp if available.",
  ...
  },
  {
    ...
    photoLabel:
      "A screenshot of the Run22 Strava group, or a solo-training photo from the COVID lockdown era.",
  ...
  },
  {
    ...
    photoAlt:
      "Brody Haar racing at the NCAA Cross Country South Region Championships in Vanderbilt colors",
    photoLabel:
      "Racing in Vanderbilt colors -- a cross country meet, ideally one that shows the SEC-level field.",
  ...
  },
  {
    ...
    photoAlt:
      "Brody Haar crossing the finish line at the Nashville Rock 'n' Roll Marathon in Brophy colors",
    photoLabel:
      "Race day or a long-run training moment from the Nashville marathon buildup.",
  ...
  },
  {
    ...
    photoLabel:
      "Actively coaching -- a workout on the track, a race on the sideline, not a posed shot.",
      ...
      <Container variant="wide">
        ...
        <section className="mt-20 border-t border-black/10 pt-16 dark:border-white/10">
          ...
          <div className="mt-6 max-w-[66ch] space-y-6 text-lg leading-8 text-zinc-600 dark:text-zinc-300">
            ...
            <p>
              Creating a free account, with an email and password or by signing
              in with Google, unlocks a dashboard: track a goal race, log recent
              results, and keep calculator results saved across visits instead
              of losing them when you close the tab. You can also connect a
              Strava account to link your training data.
            </p>
            <p>
              When you sign in with Google, we only ever request your name,
              email address, and profile photo: enough to create your account,
              nothing more. See exactly what&rsquo;s collected and why in the{" "}
              <Link
                href="/privacy-policy"
                className="font-semibold text-zinc-900 underline decoration-black/20 underline-offset-2 transition hover:decoration-black/60 dark:text-white dark:decoration-white/30 dark:hover:decoration-white/70"
              >
        ...
        <section className="pt-4 pb-4">
          ...
          <div className="mt-6 max-w-[66ch] space-y-8 text-lg leading-8 text-zinc-600 dark:text-zinc-300">
            <p>
              ...
              history, refined the same way any long-running research project
              gets refined, by being wrong sometimes and updating the record. If
